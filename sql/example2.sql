...
(
   ...
   OPESTADO             char(25),
   primary key (IDOP)
)AUTO_INCREMENT = 11234;

INSERT INTO OP (`OPCLIENTE`,`OPCIUDAD`,`OPDETALLE`,`OPREGISTRO`,`OPNOTIFICACIONCORREO`,`OPVENDEDOR`,`CEDULA`,`OPDIRECCIONLOCAL`,`OPPERESONACONTACTO`,`TELEFONO`,`OPOBSERAVACIONES`,`IDLUGAR`,`OPESTADO`)
VALUES
('PRODUBANCO', 'GYE', 'PUNTO i ROTULO', '2024-01-03 00:00:00', '2024-01-03 08:57:00', '1750541730', '0953292034', 'AGENCIA CENTRO', 'BELEN CORAL', '0984520220', '', 1, 'EN PRODUCCION'),
('PRODUBANCO', 'QUITO', 'SEÑALETICA ASCENSOR', '2024-01-03 00:00:00', '2024-01-03 08:57:00', '1750541730', '0953292034', 'AGENCIA QUICENTRO NORTE', 'BELEN CORAL', '0984520220', '', 1, 'EN PRODUCCION'),
('PRODUBANCO', 'QUITO', 'SEÑALETICA ASCENSOR', '2024-01-03 00:00:00', '2024-01-03 08:57:00', '1750541730', '0953292034', 'AGENCIA NORTE', 'BELEN CORAL', '0984520220', '', 1, 'EN PRODUCCION'),
('PRODUBANCO', 'OTAVALO', 'BOTONES DECORATIVOS', '2024-01-03 00:00:00', '2024-01-03 10:14:00', '1750541730', '0953292034', 'AGENCIA PRINCIPAL OTAVALO', 'BELEN CORAL', '0984520220', '', 1, 'EN PRODUCCION'),
('JCDECAUX', 'GYE', 'PE-PARADERO KFC', '2024-01-03 00:00:00', '2024-01-03 10:26:00', '1750541730', '0951881408', 'JC-GYE', 'ALISON TORRES', '0987254764', '', 1, 'EN PRODUCCION'),
('PRODUBANCO', 'MILAGRO', 'LONA TRANSLUCIDA CAJA DE LUZ', '2024-01-03 00:00:00', '2024-01-03 10:51:00', '1750541730', '0953292034', 'AGENCIA MILAGRO', 'BELEN CORAL', '0984520220', '', 1, 'EN PRODUCCION'),
('PRODUBANCO', 'BAÑOS', 'ORIGAMI ACRILICO', '2024-01-03 00:00:00', '2024-01-03 10:56:00', '1750541730', '0951881408', 'TOMAS HALFLANTS N6-40 ENTRE AMBATO Y ORIENTE', 'BELEN CORAL', '0984520220', '', 1, 'EN PRODUCCION');
