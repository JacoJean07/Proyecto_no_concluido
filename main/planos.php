...
if ($_SESSION["user"]["usu_rol"] || $_SESSION["user"]["usu_rol"] == 1 || $_SESSION["user"]["usu_rol"] == 2 || $_SESSION["user"]["usu_rol"] == 3 || $_SESSION["user"]["usu_rol"] == 4) {
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <?php elseif ($opPlano["pla_reproceso"] != 0) : ?>
                                                                                            ES UN REPROSESO
                                                                                        <?php elseif ($_SESSION["user"]["usu_rol"] == 1 || $_SESSION["user"]["usu_rol"] == 2 || $_SESSION["user"]["usu_rol"] == 3) : ?>
                                                                                                ...
                                                                                                <div class="modal-dialog modal-dialog-centered">
                                                                                                    <div class="modal-content">
                                                                                                        ...
                                                                                                        <div class="modal-footer">
                                                                                                            ...
                                                                                                            <a href="./cambiosEstadoPlano/reprosesoPlano.php?id=<?= $opPlano["pla_id"] ?>" class="btn btn-primary">GENERAR REPROCESO</a>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <script>
                                                                                ...
                                                                                <td>
                                                                                    <?php if ($_SESSION["user"]["usu_rol"] == 1 || $_SESSION["user"]["usu_rol"] == 3 || $_SESSION["user"]["usu_rol"] == 4) : ?>
                                                                                        <?php if ($opPlano["pla_estado"] == "ACTIVO" || $opPlano["pla_reproceso"] == 0) : ?>
